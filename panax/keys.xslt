...
>
	...
	<xsl:key name="dataset" match="data:rows[not(@xsi:nil) and not(xo:r)]" use="concat(../@xo:id,'::','')"/>
	<xsl:key name="dataset" match="data:rows/@xsi:nil" use="concat(../../@xo:id,'::','')"/>
	<xsl:key name="dataset" match="data:rows/xo:r/@*" use="concat(../../@xo:id,'::',name())"/>
	<xsl:key name="dataset" match="data:rows/xo:r/xo:f/@Name" use="concat(../../@xo:id,'::',.)"/>
